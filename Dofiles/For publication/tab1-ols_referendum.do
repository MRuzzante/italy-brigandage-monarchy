...
********************************************************************************
	...
	** CREATES:	   		"${out}/tab1-ols_referendum.tex"
	...
	* Append all locals as strings, add footnote and end of LaTeX environments
	#d	;
		file write final_table
			 ...
			 "\addlinespace[0.5em] \multicolumn{8}{c}{\large \textbf{Turnout}} 		     \\[-1em] \\ \midrule" _n
			 "\addlinespace[0.2em] `turnout'											   [0.5em]   \midrule" _n
			 "\addlinespace[0.5em] \multicolumn{8}{c}{\large \textbf{Vote for Monarchy}} \\[-1em] \\ \midrule" _n
			 "\addlinespace[0.2em] `monarchy' 											   [0.5em]   \midrule" _n
			 "\addlinespace[0.5em] \multicolumn{8}{c}{\large \textbf{Vote for Republic}} \\[-1em] \\ \midrule" _n
...
cap erase 		"${out}/tab1-ols_referendum.tex"
	sleep 		 ${sleepTime}
	filefilter  "${out}/todelete_.tex" 	         ///
				"${out}/tab1-ols_referendum.tex" ///
				 ,						         ///
				   from("[1em]") to("")
	...
	* Add link to the file (filefilter does not provide it automatically)
	di as text `"Open final file in LaTeX here: {browse "${out}/tab1-ols_referendum.tex":"${out}/tab1-ols_referendum.tex"}"'			
