...
********************************************************************************
	...
	** CREATES:	   		"${out}/tab3-2sls_referendum.tex"
...
------------------------------------------------------------------------------*/
	...
	* Loop over outcome variables
	foreach outcomeVar in turnout monarchy republic {
	...
	* Append all locals as strings, add footnote and end of LaTeX environments
	#d	;
		file write final_table
			 ...
			 "\addlinespace[0.5em] \multicolumn{6}{c}{\large \textbf{Turnout}} 		     \\[-1em] \\ \midrule" _n
			 "\addlinespace[0.2em] `turnout'											   [0.5em]   \midrule" _n
			 "\addlinespace[0.5em] \multicolumn{6}{c}{\large \textbf{Vote for Monarchy}} \\[-1em] \\ \midrule" _n
			 "\addlinespace[0.2em] `monarchy' 											   [0.5em]   \midrule" _n
			 "\addlinespace[0.5em] \multicolumn{6}{c}{\large \textbf{Vote for Republic}} \\[-1em] \\ \midrule" _n
			 "\addlinespace[0.2em] `republic'"
		;
	#d	cr
	...
	* Clean up table			
cap erase	 	"${out}/tab3-2sls_referendum.tex"
	filefilter  "${out}/todelete.tex"  			 	///
				"${out}/tab3-2sls_referendum.tex" , ///
				from("[1em]") to("") replace	
	...
	* Add link to the file (filefilter does not provide it automatically)
	di as text `"Open final file in LaTeX here: {browse "${out}/tab3-2sls_referendum.tex":"${out}/tab3-2sls_referendum.tex"}"'
