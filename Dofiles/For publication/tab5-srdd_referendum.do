...
********************************************************************************
	...
	** CREATES:	   		"${out}/tab5-srdd_referendum.tex"
...
------------------------------------------------------------------------------*/
	...
	* Clean up table			
	sleep 		 ${sleepTime}
cap erase	 	"${out}/tab5-srdd_referendum.tex"
	filefilter  "${out}/todelete.tex"  			    ///
				"${out}/tab5-srdd_referendum.tex" , ///
				from("[1em]") to("") replace	
	...
	* Add link to the file (filefilter does not provide it automatically)
	di as text `"Open final file in LaTeX here: {browse "${out}/tab5-srdd_referendum.tex":"${out}/tab5-srdd_referendum.tex"}"'
